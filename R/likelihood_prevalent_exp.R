likelihood_prevalent_exp <- function(par_trunc, par_coef, ind_coef, dataset_prevalent, xw_rule, cl, ...) {
  ...
  if (is.null(cl)) {
    ...
    loglik_pre <- fn_lik_prevalent_exp(u_ID, v_ID, Qe, cen, gamma_all, eta, px, pw, px2[,1], px2[,2], pw2)
  } else {
