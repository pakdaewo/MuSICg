likelihood_incident_grad <- function(par_coef, ind_coef, dataset_incident, cl, csum = TRUE, ...) {
  ...
  if (is.null(cl)) {
    ...
    log_trans_prob <- fun_lik_incident_grad(unique_ID, ID = ID, visit = visit, state = state, Qe = Qe, X_ID = X_ID, cen = cen, gamma_all = gamma_all, len_par = len_par)
  } else {
...
# system.time(likelihood_incident_grad(par_coef, ind_coef, dataset_incident, cl, csum = TRUE))
# system.time(likelihood_incident_grad(par_coef, ind_coef, dataset_incident, NULL, csum = TRUE))
# 
# a <- t(apply(target_ID, 2, fun_lik_incident_grad_i, ID = ID, visit = visit, state = state, Qe = Qe, X_ID = X_ID, cen = cen, gamma_all = gamma_all, len_par = len_par))
# b <- fun_lik_incident_grad(unique_ID, ID = ID, visit = visit, state = state, Qe = Qe, X_ID = X_ID, cen = cen, gamma_all = gamma_all, len_par = len_par)
# system.time(t(apply(target_ID, 2, fun_lik_incident_grad_i, ID = ID, visit = visit, state = state, Qe = Qe, X_ID = X_ID, cen = cen, gamma_all = gamma_all, len_par = len_par)))
# system.time(fun_lik_incident_grad(unique_ID, ID = ID, visit = visit, state = state, Qe = Qe, X_ID = X_ID, cen = cen, gamma_all = gamma_all, len_par = len_par))
